<template>
  <div class="container">
    ...
    <AreaList :show="showArea" :confirm="confirmArea" :cancel="()=>{showArea=false}"></AreaList>
...
export default {
  ...
  methods: {
    ...
    confirmArea(province, city) {
      console.log(province, city);
      this.areaid = province.area_id;
      this.cityid = city.area_id;
      this.value = province.area_name + " / " + city.area_name;
      this.showArea = false;
    },
    save() {
      let tel = "";
